...
var _carlosmaniero$patrocina_rodeios$Main$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_elm_lang$html$Html$text('Patrocina Rodeios'));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _carlosmaniero$patrocina_rodeios$Main$main !== 'undefined') {
    _carlosmaniero$patrocina_rodeios$Main$main(Elm['Main'], 'Main', {"types":{"unions":{},"aliases":{},"message":"msg"},"versions":{"elm":"0.18.0"}});
}
